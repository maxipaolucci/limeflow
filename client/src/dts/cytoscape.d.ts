...
declare module Cy {
    ...
    */
    ...
    interface ElementDataDefinition {
        ...
        id?: string;
        position?: Position;
        name?: string; // Custom (Yann)
        srv?: string; // Custom (Yann)
        inParam?: string[]; // Custom (Yann)
        sup?: number; // Custom (Yann)
        alt?: number; // Custom (Yann)
        src?: string[]; // Custom (Yann)
        dst?: string[]; // Custom (Yann)
        src_control?: string[]; // Custom (Yann)
        dst_control?: string[]; // Custom (Yann)
    }
    ...
    export module Css {
        ...
        export interface NodeCss {
            ...
            "content"?: any // Custom (Yann)
            "label"?: string // Custom (Yann)
            "line-color"?: Colour // Custom (Yann)
            "line-style"?: string // Custom (Yann)
            "target-arrow-color"?: Colour // Custom (Yann)
            "target-arrow-shape"?: Colour // Custom (Yann)
            "curve-style"?: string // Custom (Yann)
            "font-size"?: number // Custom (Yann)
            "text-max-width"?: number // Custom (Yann)
            "text-wrap"?: string // Custom (Yann)
        }
